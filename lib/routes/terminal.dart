...
class TerminalPageProxy extends StatelessWidget {
  @override
...
class TerminalPage extends StatefulWidget {
  ...
  const TerminalPage({Key key, this.device}) : super(key: key);
      ...
      body: Container(
        child: Column(
          children: [
            Flexible(
              child: ListView(
                children: [...messaggi.map((e) => Text(e)).toList()],
