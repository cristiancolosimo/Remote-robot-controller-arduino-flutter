...
class DiscoverSelect extends StatefulWidget {
  ...
  const DiscoverSelect({this.start = true});

  @override
  _DiscoverSelect createState() => new _DiscoverSelect();
}

class _DiscoverSelect extends State<DiscoverSelect> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: isDiscovering ? Text('Cercando') : Text('Dispositivi trovati'),
        actions: <Widget>[
          isDiscovering
              ? FittedBox(
                  child: Container(
